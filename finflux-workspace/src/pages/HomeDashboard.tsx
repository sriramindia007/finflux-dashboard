                    ...
                    <div className="lg:col-span-2 bg-white rounded-xl border border-secondary-200 shadow-sm p-5">
                        ...
                        <ResponsiveContainer width="100%" height={185}>
                            <AreaChart data={chartData} margin={{ top: 5, right: 5, left: -10, bottom: 0 }}>
                                ...
                                <Area isAnimationActive={false} type="monotone" dataKey="GLP" stroke="#6366f1" strokeWidth={2.5} fill="url(#g1)" dot={false} />
                                <Area isAnimationActive={false} type="monotone" dataKey="Disbursement" stroke="#10b981" strokeWidth={2} fill="url(#g2)" dot={false} />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2 bg-white rounded-xl border border-secondary-200 shadow-sm p-5">
                        ...
                        <ResponsiveContainer width="100%" height={140}>
                            <BarChart data={chartData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                                ...
                                <Bar isAnimationActive={false} dataKey="PAR30"
                                    radius={[3, 3, 0, 0]}
                                    fill="#f59e0b"
                                    name="PAR 30+"
                                />
